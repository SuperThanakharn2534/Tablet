...
public class OpportunityProductSuccessPay2 extends AppCompatActivity  implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opportunity_product_salecloss2);
         try {
             ...
             Log.i("Err Log", "activity_opportunity_product_salecloss2 : " + Log.getStackTraceString(e));
         }
    }
    ...
    public void setButtonclick(){
        ...
        button21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),OpportunityProductSuccessPay1.class));
            }
        });
    ...
    public void SetMenu() {
        ...
        MenuAdapter menuAdapter = new MenuAdapter(OpportunityProductSuccessPay2.this,
