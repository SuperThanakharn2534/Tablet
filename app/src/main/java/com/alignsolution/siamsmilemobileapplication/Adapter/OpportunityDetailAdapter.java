...
public class OpportunityDetailAdapter extends BaseAdapter {
    ...
    public OpportunityDetailAdapter(Context c, ArrayList<Opportunity> pOpportunityObject) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        OpportunityDetailAdapter.ViewHolder holder;
        String fullname;
        try {
            if (convertView == null) {


                convertView = l_Inflater.inflate(R.layout.activity_opportunity_detail_item, null);
                holder = new OpportunityDetailAdapter.ViewHolder();
                ...
                holder = (OpportunityDetailAdapter.ViewHolder) convertView.getTag();
            }
