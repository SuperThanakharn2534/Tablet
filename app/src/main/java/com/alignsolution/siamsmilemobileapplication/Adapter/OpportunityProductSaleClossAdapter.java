...
public class OpportunityProductSaleClossAdapter extends BaseAdapter {
    ...
    public OpportunityProductSaleClossAdapter(Context c, ArrayList<Opportunity> pOpportunityObject) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        OpportunityProductSaleClossAdapter.ViewHolder holder;
        String fullname;
        try {
            if (convertView == null) {
                ...
                holder = new OpportunityProductSaleClossAdapter.ViewHolder();
                ...
                holder = (OpportunityProductSaleClossAdapter.ViewHolder) convertView.getTag();
            }
